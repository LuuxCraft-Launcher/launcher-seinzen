...
<h1 align="center">evoldia launcher</h1>
...
Si vous téléchargez à partir des Releases, sélectionnez le programme d'installation de votre système.
 ...
 Plateforme | Fichier |
| -------- | ---- |
| Windows x64 | `Evoldia-Launcher-win-x64.exe ` |
| macOS | `Evoldia-Launcher-mac-universal.dmg` |
| Linux x64 | `Evoldia-Launcher-linux-x86_64.AppImage` |
